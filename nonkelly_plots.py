...
files = [
    ('plots-data-a0-l19-fig6.json', 'r', '-', r'Full Kelly'),
    ('0_75Kelly.json', 'b',':',r'3/4 Kelly'),
    ('0_75FixedFractionBet.json', 'orange','--',r'Fixed fraction (f = 3/4)'),
    ('all-in-FixedFractionBet.json', 'g', '-.',r'Fixed fraction (f = 1)'),
]
...
# List of JSON files and corresponding labels/colors
files = [
    ('fig10_kelly_l19_a1.json', 'r', '-', r'Full Kelly'),
    ('fig10_3-4kelly_l19_a1.json', 'b',':',r'3/4 Kelly'),
    ('fig10_3-4fixed_l19_a1.json', 'orange','--',r'Fixed fraction (f = 3/4)'),
    ('fig10_1fixed_l19_a1.json', 'g', '-.',r'Fixed fraction (f = 1)'),
]
...
# List of JSON files and corresponding labels/colors
files = [
    ('fig10_kelly_l1_a0.json', 'r', '-', r'Full Kelly'),
    ('fig10_3-4kelly_l1_a0.json', 'b',':',r'3/4 Kelly'),
    ('fig10_3-4fixed_l1_a0.json', 'orange','--',r'Fixed fraction (f = 3/4)'),
    ('fig10_1fixed_l1_a0.json', 'g', '-.',r'Fixed fraction (f = 1)'),
]
